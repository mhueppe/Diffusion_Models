...
def main():
    ...
    images_names = os.listdir(os.path.join(path_image_data, "../Pokemaenner/preprocessing/data"))
        ...
        for pokemon in pokemon_names:
            try:
                if pokemon.lower() in image.lower():
                    ...
                    shutil.move(os.path.join(path_image_data, "../Pokemaenner/preprocessing/data", image),
